 ...
 */
/*
* 给定一个每一行有序，每一列也有序，整体可能有序的二维数组，
*   在给定一个正数k，返回二维数组中，最小的第k个数
*
*   二分：
*       每次查找，要获得两个信息：① 小于mid有几个(要求是k个，不行就再二分)；②最接近mid的数是哪个(防止mid在这个数不存在于二维数组)
* */
public class Q23_最小的第k个元素 {

    // 二分的方法
    public static class Info {
        public int near;    // <= mid在矩阵中真实出现的数，谁最接近mid
        public int num;     // <= mid的个数有几个，
